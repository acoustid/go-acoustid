...
var (
	...
	TestFingerprintVersion = int32(1)
...
var (
	...
	TestFingerprint2Version = int32(1)
...
func TestParseFingerprint(t *testing.T) {
	cases := []struct {
		...
		in     []byte
		valid  bool
		fp     *common_pb.Fingerprint
		reason string
	}{
		{name: "OneItemOneBit", in: []byte{0, 0, 0, 1, 1}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{1}}},
		{name: "OneItemThreeBits", in: []byte{0, 0, 0, 1, 73, 0}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{7}}},
		{name: "OneItemOneBitExcept", in: []byte{0, 0, 0, 1, 7, 0}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{1 << 6}}},
		{name: "OneItemOneBitExcept2", in: []byte{0, 0, 0, 1, 7, 2}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{1 << 8}}},
		{name: "TwoItems", in: []byte{0, 0, 0, 2, 65, 0}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{1, 0}}},
		{name: "TwoItemsNoChange", in: []byte{0, 0, 0, 2, 1, 0}, valid: true, fp: &common_pb.Fingerprint{Version: 0, Hashes: []uint32{1, 1}}},
		{name: "Long", in: TestFingerprintData, valid: true, fp: &common_pb.Fingerprint{Version: int32(TestFingerprintVersion), Hashes: TestFingerprintHashes}},
		{name: "Long2", in: TestFingerprint2Data, valid: true, fp: &common_pb.Fingerprint{Version: int32(TestFingerprint2Version), Hashes: TestFingerprint2Hashes}},
